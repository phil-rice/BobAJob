...
class OrganisationsControllerTest < ActionController::TestCase
  ...
  test "should create organisation" do
    assert_difference('Organisation.count') do
      post :create, organisation: { email: @organisation.email, name: @organisation.name }
    end
  ...
  test "should update organisation" do
    put :update, id: @organisation, organisation: { email: @organisation.email, name: @organisation.name }
    assert_redirected_to organisation_path(assigns(:organisation))
  end
